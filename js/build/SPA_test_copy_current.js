...
//функция для формирования динамического контента через переданный код в innerHTML элементов по факту срабатывания событий - кликов по разделам меню
(function eventListeners() {
	// function manageNav () {
		var contentContainer = document.querySelector('.content');
		// var goToMyProfile = document.querySelector('.goToMyProfile');
		...
		<section class="row circlesFilter">\
							...
							<div class="col-md-4 col-xs-12 foundUsers">\
								<span class="usersNum">77</span><span class="fa fa-users"> users are found</span>\
							</div>\
							...
							<section class="row circlesDisplay">\
								<div class="row circleMember">\
									<div class="col-md-3 memberImage">\
										<img src="less/img/circles_pics/spartan.jpg" alt="Spartan">\
									</div>\
									<div class="col-md-9 memberPanel">\
										<div class="col-md-12 memberName">Spartan</div>\
										<div class="col-md-5 memberControls">\
											<div type="button" class="btn btn-primary scope">Hobbies & Interests</div>\
										</div>\
										<div class="col-md-5">\
								...
								<div class="row circleMember">\
									<div class="col-md-3 memberImage">\
										<img src="less/img/circles_pics/wolverine.jpg" alt="Wolverine">\
									</div>\
									<div class="col-md-9 memberPanel">\
										<div class="col-md-12 memberName">Wolverine</div>\
										<div class="col-md-5 memberControls">\
											<div type="button" class="btn btn-primary scope">Hobbies & Interests</div>\
										</div>\
										<div class="col-md-5">\
								...
								<div class="row circleMember">\
									<div class="col-md-3 memberImage">\
										<img src="less/img/circles_pics/jack_sparrow.jpg" alt="Jack Sparrow">\
									</div>\
									<div class="col-md-9 memberPanel">\
										<div class="col-md-12 memberName">Jack Sparrow</div>\
										<div class="col-md-5 memberControls">\
											<div type="button" class="btn btn-primary scope">Hobbies & Interests</div>\
										</div>\
										<div class="col-md-5">\
								...
								<div class="row circleMember">\
									<div class="col-md-3 memberImage">\
										<img src="less/img/circles_pics/phoebe.jpg" alt="Phoebe">\
									</div>\
									<div class="col-md-9 memberPanel">\
										<div class="col-md-12 memberName">Phoebe</div>\
										<div class="col-md-5 memberControls">\
											<div type="button" class="btn btn-primary scope">Friendship & roommates</div>\
										</div>\
										<div class="col-md-5">\
											<div type="button" class="btn btn-primary message">\
												<span class="fa fa-edit"></span>\
								...
								<div class="row circleMember">\
									<div class="col-md-3 memberImage">\
										<img src="less/img/circles_pics/rachel.jpg" alt="Rachel">\
									</div>\
									<div class="col-md-9 memberPanel">\
										<div class="col-md-12 memberName">Rachel</div>\
										<div class="col-md-5 memberControls">\
											<div type="button" class="btn btn-primary scope">Friendship & roommates</div>\
										</div>\
										<div class="col-md-5">\
								...
								<div class="row circleMember">\
									<div class="col-md-3 memberImage">\
										<img src="less/img/circles_pics/invisible_man.jpg" alt="Invisible man">\
									</div>\
									<div class="col-md-9 memberPanel">\
										<div class="col-md-12 memberName">Invisible man</div>\
										<div class="col-md-5 memberControls">\
											<div type="button" class="btn btn-primary scope">Co-working & start-ups</div>\
										</div>\
										<div class="col-md-5">\
											<div type="button" class="btn btn-primary message">\
												<span class="fa fa-edit"></span>\
								...
								<div class="row circleMember">\
									<div class="col-md-3 memberImage">\
										<img src="less/img/circles_pics/stub_picIcon.jpg" alt="Someone">\
									</div>\
									<div class="col-md-9 memberPanel">\
										<div class="col-md-12 memberName">Someone</div>\
										<div class="col-md-5 memberControls">\
											<div type="button" class="btn btn-primary scope">Co-working & start-ups</div>\
										</div>\
										<div class="col-md-5">\
		...
		// var findPeopleContent = '<div class="container-fluid myCircles findPeople">\
		// 				<section class="row findPeople">\
		...
		// 							</div>\
		// 							<div class="col-md-2">\
		// 								<div type="button" class="btn btn-primary del">Add</div>\
		// 							</div>\
 	// 							</div>\
		// 					</div>\
		// 				</section></div>'					
		...
		//временно блокирую для работы с формированием контента через xml запросы и с добавлением функции сортировки контента с ипользованием значений элемента selection, а также с добавлением функции удаления контента
		// for(var i=0; i < goToMyCircles.length; i++) {
		// 	goToMyCircles[i].addEventListener('click', function (e) {
		// 		console.log(e);
		// 		contentContainer.innerHTML="";
...
App.jsonobj = {
 	circles: [
		{
			image: "less/img/circles_pics/spartan.jpg",
			name: "Spartan",
	  	...
	  	{
	  		image: "less/img/circles_pics/wolverine.jpg",
			name: "Wolverine",
			scope: "Hobbies & Interests",
			scopeId: "2",
	      	id: "2"
	  	...
	  	{
	  		image: "less/img/circles_pics/jack_sparrow.jpg",
			name: "Jack Sparrow",
			scope: "Hobbies & Interests",
			scopeId: "2",
	      	id: "3"
	  	...
	  	{
	  		image: "less/img/circles_pics/phoebe.jpg",
			name: "Phoebe",
	  	...
	  	{
	  		image: "less/img/circles_pics/rachel.jpg",
			name: "Rachel",
			scope: "Friendship & roommates",
	      	scopeId: "4",
	      	id: "5"
	  	...
	  	{
	  		image: "less/img/circles_pics/stub_picIcon.jpg",	
			name: "Someone",
			scope: "Friendship & roommates",
	      	scopeId: "4",
	      	id: "6"
	  	...
	  	{
	  		image: "less/img/circles_pics/invisible_man.jpg",
			name: "Invisible man",
...
App.memberTemplate = (function () {
	memberContent: '<div class="col-md-3 memberImage">\
...
App.selectScope = (function () {
 var selectScope = qs('.selectScopes'); //получаем доступ к нашему элементу select

//функция, инициализирующая событие change по клику на select
 function initListeners (callbackObject) {
  selectScope.addEventListener("change", callbackObject.selectScopeChange);
 }
...
App.manageCircles = (function () {
 ...
 createMembers();
 App.selectScope.addCategories();
 App.selectScope.initListeners({
  categoryChange: categoryChange,
  priceChage: priceChage,
  selectScopeChange: selectScopeChange
 });
 ...
 function createMembers () {  
  App.jsonobj.circles.forEach(function (obj) {
   var oneMember = new App.Member(obj)
   members.push(new App.Member(obj));
  });
  filteredMembers = members;
 }

 function selectScopeChange () {
 ...
 function sortBy (val) {
  var sorters = {
   ...
   filteredMembers.sort(sorters[val]);
 }
...
// 	var circlesDisplay = document.querySelect('.circlesDisplay');
...
// 		var memberPattern = document.createElement('div');
// 		memberPattern.setAttribute('class', 'row');
// 		memberPattern.classList.add('circleMember');
// 		circlesDisplay.appendChild(memberPattern);
// 		memberPattern.innerHTML = memberContent;
...
// 			xhrModule.getAll("circles", function (memberData) {				
// 					memberData =memberData;
// 					renderAllMembers(memberData);
...
// 	function renderAllMembers (memberData) {
// 			for (var i in memberData) {
// 				addMember(memberData[i]);
// 			}
...
// 			var member = newMember(data);
// 			var self = this;

// 			circles.push(member); //метод push для массива circles позволит подставить в конец массива данные из переменной member, который сформируются путем вызова еще одной функции newMember(data);
// 			circlesDisplay.appendChild(member); //в наш див circlesDisplay добавим новый элемент task
// 		}	


// 	function newMember (content) {
// 			var taskElement, image, name, scope, delMember, id;
...
// 					xhrModule.deleteRecord(id, "circles", function () {
// 						destroy();
// 					}, xhrModule.failedRequest);
// 				});
							
// 				addButton.addEventListener("click", function (e) {
// 					xhrModule.create({}, "tasks", function (data) {
// 					getAllMembers();
// 					renderAllMembers();
// 					console.log(e);
// 				});		
...
// 			function destroy () {
// 				memberContent.remove(); //The jQuery remove() method removes the selected element(s) and its child elements.
// 			}
...
App.jsonobj = (function () {
	...
	function getAllMembers () {
			xhrModule.getAll("circles", function (circlesData) {
					circlesData = circlesData;
					renderAllMembers(circlesData);
			}, xhrModule.failedRequest);
		}


		// callback(JSON.parse(newRequest.responseText));	

	function renderAllMembers (circlesData) {
		for (var i in circlesData) {
			createMembers(circlesData[i]);
		}
	}
	...
	function createMembers (data) {
		...
		var self = this;
		members.push(member); //метод push для массива tasks позволит подставить в конец массива данные из переменной task, который сформируются путем вызова еще одной функции newTask(data);
	}	
	...
	function getAllScopes () {
			xhrModule.getAll("scopes", function (scopesData) {				
					...
					renderAllScopes(scopesData);
			}, xhrModule.failedRequest);
		}

	function renderAllScopes (scopesData) {
		for (var i in scopesData) {
			createScopes(scopesData[i]);
		}
	}

	function createScopes (data) {
		var scope = function () {
			for (var i in data) {
				this[i] = data[i];
			};
		...
		var self = this;
		scopes.push(scope); //метод push для массива tasks позволит подставить в конец массива данные из переменной task, который сформируются путем вызова еще одной функции newTask(data);
	}	
	...
	// function getAllMembers () {
	// 		xhrModule.getAll("circles", createMembers, xhrModule.failedRequest);
	// }

	// function getAllScopes () {
	// 		xhrModule.getAll("scopes", addScopes, xhrModule.failedRequest);
	// }

	// function createMembers () {  
	// 	getAllMembers.forEach(function (obj) {
...
App.selectScope = (function () {
	// var selectScope = qs('.selectScopes'); //получаем доступ к нашему элементу select
	// var resetSearch = qs('.searchReset');
	// var contentContainer = document.querySelector('.content');
	// var selectScope = document.createElement('div');
	// selectScope.setAttribute('class','selectScopes');
	// var resetSearch = document.createElement('div');
	// resetSearch.setAttribute('class','searchReset');
	// contentContainer.appendChild(selectScope);
	// contentContainer.appendChild(resetSearch);
	...
	//функция, инициализирующая событие change по клику на select
	function initListeners (callbackObject) {
		// selectScope.addEventListener("change", callbackObject.scopeChange);
		// // selectScope.addEventListener("change", callbackObject.selectScopeChange)
		// resetSearch.addEventListener("click", callbackObject.resetFilter);
...
App.manageCircles = (function () {
	var membersOne = []; //создаем пустой массив для сохранения отсортированных пользователей, информацию о которых мы получили из jsonobj
	...
	createAllMembers(); //вызываем функцию createMembers
	
	// function createMembers () {  
	// 	App.jsonobj.getAllMembers.forEach(function (obj) {
	// 		var oneMember = new App.Member(obj); //создаем новый объект класса Member и пушим его в наш массив members
	// 		members.push(new App.Member(obj));
	// 	});
	...
	function createAllMembers () {  
		App.jsonobj.members.forEach(function (obj) {
			var oneMember = new App.Member(obj); //создаем новый объект класса Member и пушим его в наш массив members
			membersOne.push(new App.Member(obj));
		});

		
		//выводим количество пользователей в наших кругах в меню навигации
		navTotalMembers(membersOne);
		//далее массив filteredMembers подменяем контентом массива members
		filteredMembers = membersOne;
	}
	...
	function scopeChange () {
	 	...
	 	//в массив filteredMembers перезаписываем результат, полученный после применения метода filter к массиву members. Метод фильтр вернет нам значение из массива members, которое будет равно значению текущей переменной val
	  	filteredMembers = membersOne.filter(function (member) {
	   		return member.scopeId === val;
	 	});
	...
	function resetFilter () {
		...
		renderMembers(membersOne);
		countTotalMembers(membersOne);
		App.selectScope.addScopes();
		filteredMembers = membersOne;
	}
...
xhrUtils.getAll("circles", renderCircle, xhrUtils.failedRequest);

function renderMember (memberData) {
        for (var i in memberData) {
            createComment(memberData[i]);
        }
    }
    function createMember (data) {
        var member = newMember(data);
        members.push(member);
        circles.appendChild(member);
    }
...
App.selectScope = (function () {
	...
	// 	data = data;  
	// 	// var scopes = App.jsonobj.circles();
	// 	data.forEach(function (val) {  
	// 		data.innerHTML+= '<option value="' + val.id + '">' + val.name +'</option>';
	// 	})
	// }
...
App.Member = (function () {
	var Member = function (data) {
		...
		this.template = App.memberTemplates.memberContent;
		this.scopes = scopes.filter(function (val) {
			return val.id === data.scopeId;
		})[0];
	};
...
App.selectScope = (function () {
	...
	function renderAllScopes (scopesData) {
			for (var i in scopesData) {
				createScope(scopesData[i]);
			}
	}

	function createScope (data) {
		var scope = newScope(data);
		var self = this;

		scopes.push(scope); //метод push для массива tasks позволит подставить в конец массива данные из переменной task, который сформируются путем вызова еще одной функции newTask(data);
		// frame.appendChild(task); //в наш див frame добавим новый элемент task
	}	
		//выводим количество пользователей в наших кругах в меню навигации
		
	function newScope (content) { 
		var select = document.querySelectorAll("select");
		addScopes();
		...
		function addScopes () {
			...
			select.innerHTML+= '<option value="' + content.id + '">' + content.name +'</option>';
			}
		}
	}
	...
	return {
		renderAllScopes: renderAllScopes,
		initListeners: initListeners
	}
...
App.Member = (function () {
	var Member = function (data) {
		...
		this.template = App.memberTemplates.memberContent;
		this.scopes = App.manageCircles.circles.filter(function (val) {
			return val.id === data.scopeId;
		})[0];
	};
...
App.manageCircles = (function () {
	...
	function getAllMembers () {
			xhrModule.getAll("circles", function (membersData) {
					membersData = membersData;
					renderAllMembers(membersData);
			}, xhrModule.failedRequest);
	}

	//пишем функцию для импорта данных из джейсон объекта (по которому мы проходимся циклом) и отображения структуры данных на странице браузера каждого объекта в массиве tasks, благодаря вызову функции buildTasksBlock, которая построит ДОМ-фрагмент для блока задача и добавит его в общую ДОМ-модель
	function renderAllMembers (membersData) {
			for (var i in membersData) {
				createMember(membersData[i]);
			}
	}
	...
	function createScope (data) {
			var circle = newCircle(data);
			var self = this;
			circles.push(circle);

			addScopes(circles);
		
		//метод push для массива tasks позволит подставить в конец массива данные из переменной task, который сформируются путем вызова еще одной функции newTask(data);
	...
	var newCircle = function () {
		var Circle = function (data) {
			...
			this.template = App.scopeTemplates.scopeContent;
			// this.scopes = App.jsonobj.scopes.filter(function (val) {
			// 	return val.id === data.scopeId;
			// })[0];
		};
	...
	return Circle; //возвращаем результат функции, сохраненной в переменную Member
	...
	function renderMembers (membersArray) {
	  	...
	  	membersArray.forEach(function () {
	   		html+= App.memberTemplates.memberContent;
	 		function getHTML (arg) {
	 			this.arg = this.html;
				var reg = /{{([A-Za-z0-9\+\-\_\,\ ]+)}}/g;
				var self = this;
				return this.replace(reg, function (substring) {
 				return self[substring.split(/{|}/).join("")];
				});
			} 
	 	});
	...
	function addScopes (membersArray) {
		circles.forEach(function (val) { 
		circles.innerHTML+= '<option value="' + val.id + '">' + val.name +'</option>';
		})
	}
...
App.main = (function () {
	...
	function newTask (content) {
			...
			function createTerm () {
				...
				termText.innerHTML = "It's " + howLong() + " left";
